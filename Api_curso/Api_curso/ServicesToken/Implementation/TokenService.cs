using Api_curso.Configurations;
...
namespace Api_curso.ServicesToken.Implementation {
    public class TokenService : ITokenService {
        ...
        //clain  payload são os objetos que contem as informaçõs JSON
        ...
        //metodo responsavel por gerar o RefreshToken
        public string GenerateRefreshToken() {
            var randomNamber = new byte[32];
            using (var randomico = RandomNumberGenerator.Create()) {
                randomico.GetBytes(randomNamber);
